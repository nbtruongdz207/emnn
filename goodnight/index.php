...
<head>
    ...
    <meta content='Anhcode' name='description' />
    <meta content='HTML, Anhcode, Feeldream' name='keywords' />
    <meta content='Anhcode' name='author' />
    ...
    <meta content='Gửi bée' name='description' />
    ...
    body::before {
        content: "\00A9  Anhcode.click- Convert:AnhCode";
        color: white;
        opacity: 0.7;
        font-size: 10px;
        position: fixed;
    ...
    #suratin img {
        ...
        width: 130px;
        height: 130px;
        animation: rto .7s infinite alternate;
        transition: all .3s ease
    }
...
<body>
    <!-- Nhạc -->
    <audio class='sembunyi' id='linkmp3' src='https://thhlam77.github.io/music/nhac.mp3'></audio>
    <div id='bodyblur'>
        <!-- Nền --><img id='wallpaper'
            src='https://i.pinimg.com/1200x/d8/fa/29/d8fa29eb2ec089b407a241512956dd43.jpg' />
    ...
    <div id='Content'>
        ...
        <p id='ket'>Mở quà đi nà bé iuu!</p>
        <div class='kumpulanstiker'>
            <!-- Stiker untuk Konten -->
            <img id='stiker1' src='https://feeldreams.github.io/pusn.gif' />
            <img id='stiker2' src='https://feeldreams.github.io/bunga.gif' />
            <img id='stiker3' src='https://feeldreams.github.io/mndkat.gif' />
            <img id='stiker4' src='https://feeldreams.github.io/smprt.gif' />
            <img id='stiker5' src='https://feeldreams.github.io/ngumpet.gif' />
            <!-- Stiker untuk Akhiran -->
            <img id='stiker' onClick='ftaksi();' src='https://feeldreams.github.io/bunga.gif' />
            <img id='stikerAkhir' src='https://feeldreams.github.io/bunga.gif' />
        </div>
        <p id='halo'>Ngủ ngoann!</p>
        ...
        async function pesanAwal() {
            ...
            await swalst.fire({
                title: 'Tuyệt sắc giai nhân phải ngủ sớm 🤭&#10084;&#65039;',
                imageUrl: '' + stiker3.src,
            });
            await swalst.fire({
                title: 'Sáng dậy tỉnh táo để ta ôm 🥺&#10084;&#65039;',
                imageUrl: '' + stiker4.src,
            });
            await swalst.fire({
                title: 'emm ngủ ngoann nhaa 😘💕',
        ...
        <div>
            <blockquote id='bq'>
                <!-- Konten Pembukaan -->
                <p id='kalimat'>Chỉ có vậy thôiii🤭&#10084;&#65039; </p>
                <p id='kalimat2'>Muộn rồi, ngủ đi nhoa, xíu mình lại nói chuyện trong mơ tiếp 💋</p>
                <p id='kalimatbawah'>Yêu cậuuu &#10084;&#65039;</p>
                <p class='sembunyi' id='kalimatbawah2'>Ngủ ngoann &#10084;&#65039;</p>
                <p class='sembunyi' id='kalimatbawah3'>Thích cậu nhiềuu &#10084;&#65039;</p>
            </blockquote>
        </div>
        <!-- Tombol Multifungsi -->
        <div id='Tombol'>
            <a href='https://m.me/kvna.2008' target='_blank'>
                <b id='tmbl'>💌 Nhắn tin choa béo nha</b>
            </a>
        </div>
        <!-- Phần này không đụng nha =)) -->
        <span class='sembunyi' id='pesanWA'>Awww Good Night too &#10084;&#65039;&#10084;&#65039;&#10084;&#65039;</span>
    </div>
    <script>
    ftom = 0;
    aksift = 0;
    ...
    <div class='no-items section' id='Anhcode'></div>
